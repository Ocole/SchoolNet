...
public abstract class BaseAdapter<M, H extends BaseHolder<M>> extends RecyclerView.Adapter<H> {
     ...
     * @param listener 回调接口
     */
    public BaseAdapter(@Nullable List<M> list, @Nullable ItemClickSupport listener) {
        this.dataList = list;
...
//                    listener.setOnItemClickListener((ItemClickSupport.OnItemClickListener) holder);
//                }
//            });
//        }
    }
